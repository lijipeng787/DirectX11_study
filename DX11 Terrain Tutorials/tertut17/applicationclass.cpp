...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd,
  ...
  result = m_ColorTexture1->Initialize(m_Direct3D->GetDevice(),
                                       L"../tertut17/data/dirt001.dds");
  if (!result) {
    return false;
  }
  ...
  result = m_ColorTexture2->Initialize(m_Direct3D->GetDevice(),
                                       L"../tertut17/data/dirt004.dds");
  if (!result) {
    return false;
  }
  ...
  result = m_ColorTexture3->Initialize(m_Direct3D->GetDevice(),
                                       L"../tertut17/data/dirt002.dds");
  if (!result) {
    return false;
  }
  ...
  result = m_ColorTexture4->Initialize(m_Direct3D->GetDevice(),
                                       L"../tertut17/data/stone001.dds");
  if (!result) {
    return false;
  }
  ...
  result = m_AlphaTexture1->Initialize(m_Direct3D->GetDevice(),
                                       L"../tertut17/data/alpha001.dds");
  if (!result) {
    return false;
  }
  ...
  // Load the first alpha texture object.
  result = m_NormalTexture1->Initialize(m_Direct3D->GetDevice(),
                                        L"../tertut17/data/normal001.dds");
  if (!result) {
    return false;
  }
  ...
  result = m_NormalTexture2->Initialize(m_Direct3D->GetDevice(),
                                        L"../tertut17/data/normal002.dds");
  if (!result) {
    return false;
  }
...
bool ApplicationClass::Render() {
  ...
  result = m_TerrainShader->Render(
      ...
      m_ColorTexture1->GetTexture(), m_ColorTexture2->GetTexture(),
      m_ColorTexture3->GetTexture(), m_ColorTexture4->GetTexture(),
