...
bool DepthShaderClass::Initialize(ID3D11Device *device, HWND hwnd) {
  ...
  result = InitializeShader(device, hwnd, L"../tertut13/depth.vs",
                            L"../tertut13/depth.ps");
  if (!result) {
    return false;
  }
...
bool DepthShaderClass::Render(ID3D11DeviceContext *deviceContext,
...
void DepthShaderClass::RenderShader(ID3D11DeviceContext *deviceContext,
                                    int indexCount) {
