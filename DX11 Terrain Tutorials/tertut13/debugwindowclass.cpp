...
bool DebugWindowClass::Initialize(ID3D11Device *device, int screenWidth,
                                  int screenHeight, int bitmapWidth,
                                  int bitmapHeight) {
  bool result;
...
bool DebugWindowClass::Render(ID3D11DeviceContext *deviceContext, int positionX,
                              int positionY) {
  bool result;
...
int DebugWindowClass::GetIndexCount() { return m_indexCount; }
...
bool DebugWindowClass::UpdateBuffers(ID3D11DeviceContext *deviceContext,
