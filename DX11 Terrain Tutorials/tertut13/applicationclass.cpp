...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_Terrain->Initialize(m_Direct3D->GetDevice(), "../../tertut13/data/heightmap01.bmp", L"../../tertut13/data/dirt01.dds", 
								   "../../tertut13/data/colorm01.bmp", L"../../tertut13/data/detail001.dds");
	if(!result)
	{
