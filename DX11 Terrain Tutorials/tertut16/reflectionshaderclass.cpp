...
bool ReflectionShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../../tertut16/reflection.vs", L"../../tertut16/reflection.ps");
	if(!result)
	{
		return false;
	}
...
bool ReflectionShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, 
								   ...
								   const XMFLOAT4& lightDiffuseColor, const XMFLOAT3&lightDirection, float colorTextureBrightness, const XMFLOAT4&clipPlane)
{
	bool result;
...
bool ReflectionShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, 
												...
												ID3D11ShaderResourceView* normalTexture, const XMFLOAT4&lightDiffuseColor, const XMFLOAT3&lightDirection, 
												float colorTextureBrightness, const XMFLOAT4&clipPlane)
{
	HRESULT result;
