...
bool TerrainShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../../tertut16/terrain.vs", L"../../tertut16/terrain.ps");
	if(!result)
	{
		return false;
	}
...
bool TerrainShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, 
								...
								const XMFLOAT4& lightDiffuseColor, const XMFLOAT3&lightDirection, float colorTextureBrightness)
{
	bool result;
