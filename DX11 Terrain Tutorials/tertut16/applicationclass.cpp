...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_Terrain->Initialize(m_Direct3D->GetDevice(), "../../tertut16/data/hm.bmp", "../../tertut16/data/cm.bmp", 20.0f, L"../../tertut16/data/dirt.dds", 
	...
	m_TerrainShader = ( TerrainShaderClass* )_aligned_malloc( sizeof( TerrainShaderClass ), 16 );
	...
	m_SkyDomeShader = ( SkyDomeShaderClass* )_aligned_malloc( sizeof( SkyDomeShaderClass ), 16 );
	...
	result = m_SkyPlane->Initialize(m_Direct3D->GetDevice(), L"../../tertut16/data/cloud001.dds", L"../../tertut16/data/perturb001.dds");
	if(!result)
	{
	...
	m_SkyPlaneShader = ( SkyPlaneShaderClass* )_aligned_malloc( sizeof( SkyPlaneShaderClass ), 16 );
	...
	m_FontShader = ( FontShaderClass* )_aligned_malloc( sizeof( FontShaderClass ), 16 );
	...
	m_RefractionTexture = ( RenderTextureClass* )_aligned_malloc( sizeof( RenderTextureClass ), 16 );
	...
	m_ReflectionTexture = ( RenderTextureClass* )_aligned_malloc( sizeof( RenderTextureClass ), 16 );
	...
	result = m_Water->Initialize(m_Direct3D->GetDevice(), L"../../tertut16/data/waternormal.dds", 3.75f, 110.0f);
	if(!result)
	{
