...
void TerrainClass::CalculateTerrainVectors() {
  ...
  // Go through all the faces and calculate the the tangent, binormal, and
  // normal vectors.
...
bool TerrainClass::InitializeBuffers(ID3D11Device *device) {
  ...
  for (i = 0; i < m_vertexCount; i++) {
    vertices[i].position =
        XMFLOAT3(m_TerrainModel[i].x, m_TerrainModel[i].y, m_TerrainModel[i].z);
    vertices[i].texture = XMFLOAT2(m_TerrainModel[i].tu, m_TerrainModel[i].tv);
    vertices[i].normal = XMFLOAT3(m_TerrainModel[i].nx, m_TerrainModel[i].ny,
                                  m_TerrainModel[i].nz);
    vertices[i].tangent = XMFLOAT3(m_TerrainModel[i].tx, m_TerrainModel[i].ty,
                                   m_TerrainModel[i].tz);
    vertices[i].binormal = XMFLOAT3(m_TerrainModel[i].bx, m_TerrainModel[i].by,
                                    m_TerrainModel[i].bz);
