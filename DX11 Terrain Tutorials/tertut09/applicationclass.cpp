...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd,
  ...
  result = m_Terrain->Initialize(
      m_Direct3D->GetDevice(), "../tertut09/data/heightmap01.bmp",
      "../tertut09/data/legend.txt", "../tertut09/data/materialmap01.bmp",
      "../tertut09/data/colorm01.bmp");
  if (!result) {
...
bool ApplicationClass::RenderGraphics() {
  ...
  result = m_Terrain->Render(
      m_Direct3D->GetDeviceContext(), m_TerrainShader, worldMatrix, viewMatrix,
