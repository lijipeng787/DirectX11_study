...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd,
  ...
  result = m_Terrain->Initialize(
      m_Direct3D->GetDevice(), "../tertut11/data/heightmap01.bmp",
      L"../tertut11/data/dirt01.dds", "../tertut11/data/colorm01.bmp");
  if (!result) {
  ...
  result = m_SkyPlane->Initialize(m_Direct3D->GetDevice(),
                                  L"../tertut11/data/cloud001.dds",
                                  L"../tertut11/data/cloud002.dds");
  if (!result) {
...
bool ApplicationClass::RenderGraphics() {
  ...
  m_SkyPlaneShader->Render(
      ...
      viewMatrix, projectionMatrix, m_SkyPlane->GetCloudTexture1(),
      m_SkyPlane->GetCloudTexture2(), m_SkyPlane->GetTranslation(0),
      m_SkyPlane->GetTranslation(1), m_SkyPlane->GetTranslation(2),
