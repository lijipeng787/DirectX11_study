...
public:
	...
	void Shutdown();
	bool Render( ID3D11DeviceContext*, int, const XMMATRIX&, const XMMATRIX&, const XMMATRIX&, const XMFLOAT4&, const XMFLOAT4& );
...
private:
	...
	bool SetShaderParameters( ID3D11DeviceContext*, const XMMATRIX&, const XMMATRIX&, const XMMATRIX&, const XMFLOAT4&, const XMFLOAT4& );
