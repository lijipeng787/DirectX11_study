...
TransparentDepthShaderClass::TransparentDepthShaderClass(
    const TransparentDepthShaderClass &other) {}
...
bool TransparentDepthShaderClass::Initialize(HWND hwnd) {
  ...
  result = InitializeShader(hwnd, L"../../tut49/transparentdepth.vs",
                            L"../../tut49/transparentdepth.ps");
  if (!result) {
    return false;
  }
...
void TransparentDepthShaderClass::Shutdown() { ShutdownShader(); }

bool TransparentDepthShaderClass::Render(int indexCount,
...
bool TransparentDepthShaderClass::InitializeShader(HWND hwnd, WCHAR *vsFilename,
                                                   WCHAR *psFilename) {
  HRESULT result;
  ...
  result = D3DCompileFromFile(
      vsFilename, NULL, NULL, "TransparentDepthVertexShader", "vs_5_0",
  ...
  result = D3DCompileFromFile(
      psFilename, NULL, NULL, "TransparentDepthPixelShader", "ps_5_0",
...
void TransparentDepthShaderClass::OutputShaderErrorMessage(
...
bool TransparentDepthShaderClass::SetShaderParameters(
