...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_GroundModel->Initialize(m_Direct3D->GetDevice(), "../../tut49/data/plane01.txt", L"../../tut49/data/dirt.dds", 2.0f);
	if(!result)
	{
	...
	result = m_Tree->Initialize(m_Direct3D->GetDevice(), "../../tut49/data/trees/trunk001.txt", L"../../tut49/data/trees/trunk001.dds", "../../tut49/data/trees/leaf001.txt", L"../../tut49/data/trees/leaf001.dds", 0.1f);
	if(!result)
	{
