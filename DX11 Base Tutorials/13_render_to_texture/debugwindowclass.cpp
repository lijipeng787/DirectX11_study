...
bool DebugWindowClass::Initialize(int screenWidth, int screenHeight,
...
void DebugWindowClass::Shutdown() { ShutdownBuffers(); }
...
int DebugWindowClass::GetIndexCount() { return index_count_; }
