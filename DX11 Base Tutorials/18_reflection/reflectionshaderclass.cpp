...
bool ReflectionShaderClass::Initialize(HWND hwnd) {
  ...
  auto result = InitializeShader(hwnd, L"reflection.hlsl", L"reflection.hlsl");
  if (!result) {
    return false;
  }
...
void ReflectionShaderClass::Shutdown() { ShutdownShader(); }
...
bool ReflectionShaderClass::InitializeShader(HWND hwnd, WCHAR *vsFilename,
                                             WCHAR *psFilename) {
  ...
  auto result = D3DCompileFromFile(
      vsFilename, NULL, NULL, "ReflectionVertexShader", "vs_5_0",
