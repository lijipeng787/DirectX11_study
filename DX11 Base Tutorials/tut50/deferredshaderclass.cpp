...
void DeferredShaderClass::Shutdown() { ShutdownShader(); }

bool DeferredShaderClass::Render(int indexCount, const XMMATRIX &worldMatrix,
...
bool DeferredShaderClass::InitializeShader(HWND hwnd, WCHAR *vsFilename,
                                           WCHAR *psFilename) {
  HRESULT result;
  ...
  result = D3DCompileFromFile(vsFilename, NULL, NULL, "DeferredVertexShader",
  ...
  result = D3DCompileFromFile(psFilename, NULL, NULL, "DeferredPixelShader",
...
void DeferredShaderClass::OutputShaderErrorMessage(ID3D10Blob *errorMessage,
                                                   HWND hwnd,
...
bool DeferredShaderClass::SetShaderParameters(
