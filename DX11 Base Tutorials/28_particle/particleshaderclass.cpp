...
bool ParticleShaderClass::Initialize(HWND hwnd) {
  ...
  auto result = InitializeShader(hwnd, L"particle.hlsl", L"particle.hlsl");
  if (!result) {
    return false;
  }
...
void ParticleShaderClass::Shutdown() { ShutdownShader(); }

bool ParticleShaderClass::Render(int indexCount, const XMMATRIX &worldMatrix,
...
bool ParticleShaderClass::InitializeShader(HWND hwnd, WCHAR *vsFilename,
                                           WCHAR *psFilename) {
  ...
  auto result = D3DCompileFromFile(
      vsFilename, NULL, NULL, "ParticleVertexShader", "vs_5_0",
  ...
  result = D3DCompileFromFile(psFilename, NULL, NULL, "ParticlePixelShader",
...
void ParticleShaderClass::OutputShaderErrorMessage(ID3D10Blob *errorMessage,
                                                   HWND hwnd,
...
bool ParticleShaderClass::SetShaderParameters(
