...
bool GraphicsClass::Render() {
  ...
  result = m_ShadowShader->Render(
      ...
      lightViewMatrix, lightOrthoMatrix, m_CubeModel->GetTexture(),
      render_texture_->GetShaderResourceView(), light_->GetDirection(),
  ...
  result = m_ShadowShader->Render(
      ...
      lightViewMatrix, lightOrthoMatrix, m_SphereModel->GetTexture(),
      render_texture_->GetShaderResourceView(), light_->GetDirection(),
      light_->GetAmbientColor(), light_->GetDiffuseColor());
  if (!result) {
    return false;
  ...
  result = m_ShadowShader->Render(
      ...
      lightViewMatrix, lightOrthoMatrix, m_GroundModel->GetTexture(),
      render_texture_->GetShaderResourceView(), light_->GetDirection(),
      light_->GetAmbientColor(), light_->GetDiffuseColor());
  if (!result) {
    return false;
