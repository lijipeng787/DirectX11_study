...
bool TranslateShaderClass::Render(ID3D11DeviceContext* device_context, int indexCount, const XMMATRIX& worldMatrix, 
...
bool TranslateShaderClass::SetShaderParameters(ID3D11DeviceContext* device_context, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix,
...
void TranslateShaderClass::RenderShader(ID3D11DeviceContext* device_context, int indexCount)
{
