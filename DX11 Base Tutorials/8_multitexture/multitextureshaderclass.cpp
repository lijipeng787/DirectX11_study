...
bool MultiTextureShaderClass::Initialize(HWND hwnd) {

  auto result =
      InitializeShader(hwnd, L"multitexture.hlsl", L"multitexture.hlsl");
  if (!result) {
    return false;
  }
...
void MultiTextureShaderClass::Shutdown() { ShutdownShader(); }

bool MultiTextureShaderClass::Render(int indexCount,
...
bool MultiTextureShaderClass::InitializeShader(HWND hwnd, WCHAR *vsFilename,
                                               WCHAR *psFilename) {
  ...
  auto result = D3DCompileFromFile(
      vsFilename, NULL, NULL, "MultiTextureVertexShader", "vs_5_0",
  ...
  result = D3DCompileFromFile(psFilename, NULL, NULL, "MultiTexturePixelShader",
