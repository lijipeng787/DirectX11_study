...
bool SimpleMoveableSurface::Initialize(ID3D11Device* device, int screenWidth, int screenHeight, WCHAR* textureFilename, int bitmapWidth, int bitmapHeight)
{
	bool result;
...
bool SimpleMoveableSurface::LoadTexture(ID3D11Device* device, WCHAR* filename)
{
	bool result;
