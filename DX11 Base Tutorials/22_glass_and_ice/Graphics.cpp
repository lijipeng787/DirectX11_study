...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd) {
...

	{
		...
		result = model_->Initialize("data/cube.txt", L"data/seafloor.dds", L"data/bump03.dds");
		if (!result) {
		...
		result = window_model_->Initialize("data/square.txt", L"data/glass01.dds", L"data/bump03.dds");
		if (!result) {
