...
bool MultiTextureShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../../tut17/multitexture.vs", L"../../tut17/multitexture.ps");
	if(!result)
	{
		return false;
	}
...
bool MultiTextureShaderClass::Render(ID3D11DeviceContext* device_context, int indexCount, const XMMATRIX& worldMatrix, 
...
bool MultiTextureShaderClass::SetShaderParameters(ID3D11DeviceContext* device_context, const XMMATRIX& worldMatrix, 
...
void MultiTextureShaderClass::RenderShader(ID3D11DeviceContext* device_context, int indexCount)
{
