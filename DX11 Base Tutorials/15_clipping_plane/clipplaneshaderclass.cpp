...
bool ClipPlaneShaderClass::Initialize(HWND hwnd) {
  ...
  auto result = InitializeShader(hwnd, L"clipplane.hlsl", L"clipplane.hlsl");
  if (!result) {
    return false;
  }
...
void ClipPlaneShaderClass::Shutdown() { ShutdownShader(); }
...
bool ClipPlaneShaderClass::InitializeShader(HWND hwnd, WCHAR *vsFilename,
                                            WCHAR *psFilename) {
  ...
  auto result = D3DCompileFromFile(
      vsFilename, NULL, NULL, "ClipPlaneVertexShader", "vs_5_0",
  ...
  result = D3DCompileFromFile(psFilename, NULL, NULL, "ClipPlanePixelShader",
...
void ClipPlaneShaderClass::OutputShaderErrorMessage(ID3D10Blob *errorMessage,
                                                    HWND hwnd,
