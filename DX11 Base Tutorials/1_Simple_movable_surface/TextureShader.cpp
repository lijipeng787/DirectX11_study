...
bool TextureShader::Initialize(HWND hwnd) {
  ...
  auto result = InitializeShader(
      ...
      // L"../../1_Simple_movable_surface/simple_texture_shader.hlsl"
      L"simple_texture_shader.hlsl", L"simple_texture_shader.hlsl");
...
bool TextureShader::Render(int indexCount, const XMMATRIX &worldMatrix,
...
bool TextureShader::InitializeShader(HWND hwnd, WCHAR *vsFilename,
                                     WCHAR *psFilename) {
  ...
  auto result = D3DCompileFromFile(
      vsFilename, NULL, NULL, "TextureVertexShader", "vs_5_0",
...
bool TextureShader::SetShaderParameters(const XMMATRIX &worldMatrix,
                                        const XMMATRIX &viewMatrix,
                                        const XMMATRIX &projectionMatrix,
                                        ID3D11ShaderResourceView *texture) {
