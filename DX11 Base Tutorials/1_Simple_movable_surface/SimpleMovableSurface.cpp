...
void SimpleMoveableSurface::InitializeWithSurfaceSize(int bitmapWidth,
                                                      int bitmapHeight) {

  screen_width_ = DirectX11Device::GetD3d11DeviceInstance()->GetScreenWidth();
  screen_height_ =
      ::DirectX11Device::GetD3d11DeviceInstance()->GetScreenHeight();
...
bool SimpleMoveableSurface::UpdateBuffers() {
  ...
  if ((position_x_ == previous_posititon_x_) &&
      (position_y_ == previous_posititon_y_)) {
    return true;
  }
