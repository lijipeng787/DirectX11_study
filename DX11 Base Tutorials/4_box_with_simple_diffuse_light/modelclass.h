...
public:
	bool Initialize(const std::string& modelFilename, const std::wstring& textureFilename);

	void Shutdown();

	// Implement the IRenderable interface
	void Render(const IShader& shader, const DirectX::XMMATRIX& viewMatrix, const DirectX::XMMATRIX& projectionMatrix) const override;
