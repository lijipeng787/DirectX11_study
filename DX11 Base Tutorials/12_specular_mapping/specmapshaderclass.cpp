...
bool SpecMapShaderClass::Initialize(HWND hwnd) {
  ...
  auto result =
      InitializeShader(hwnd, L"specularmap.hlsl", L"specularmap.hlsl");
  if (!result) {
    return false;
  }
...
void SpecMapShaderClass::Shutdown() { ShutdownShader(); }
...
bool SpecMapShaderClass::Render(
  ...
  auto result = SetShaderParameters(
      worldMatrix, viewMatrix, projectionMatrix, textureArray, lightDirection,
...
bool SpecMapShaderClass::InitializeShader(HWND hwnd, WCHAR *vsFilename,
                                          WCHAR *psFilename) {
  ...
  auto result = D3DCompileFromFile(
      vsFilename, NULL, NULL, "SpecMapVertexShader", "vs_5_0",
  ...
  result = D3DCompileFromFile(psFilename, NULL, NULL, "SpecMapPixelShader",
...
void SpecMapShaderClass::OutputShaderErrorMessage(ID3D10Blob *errorMessage,
                                                  HWND hwnd,
