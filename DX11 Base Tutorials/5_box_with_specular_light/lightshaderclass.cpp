...
bool LightShaderClass::Initialize(HWND hwnd) {
	...
	auto result = InitializeShader(hwnd, L"../../5_box_with_specular_light/specular_light.hlsl", L"../../5_box_with_specular_light/specular_light.hlsl");
	if (!result) {
		return false;
	}
...
bool LightShaderClass::Render(int indexCount,
	...
	auto result = SetShaderParameters(worldMatrix, viewMatrix, projectionMatrix, texture, lightDirection, ambientColor, diffuseColor,
...
bool LightShaderClass::InitializeShader(HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename) {
	...
	auto result = D3DCompileFromFile(vsFilename, NULL, NULL, "LightVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
...
bool LightShaderClass::SetShaderParameters(const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix,
										   ...
										   const XMFLOAT4& diffuseColor, const XMFLOAT3& cameraPosition,
