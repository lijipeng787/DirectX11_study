...
bool TextureShaderClass::Initialize(HWND hwnd) {
	...
	auto result = InitializeShader(hwnd, L"../../3_blur_demo/texture.hlsl", L"../../3_blur_demo/texture.hlsl");
	if (!result) {
		return false;
	}
...
bool TextureShaderClass::InitializeShader(HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename) {
	...
	auto result = D3DCompileFromFile(vsFilename, NULL, NULL, "TextureVertexShader", "vs_5_0", flag, 0,
	...
	result = D3DCompileFromFile(psFilename, NULL, NULL, "TexturePixelShader", "ps_5_0", flag, 0,
