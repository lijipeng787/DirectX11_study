...
bool ProjectionShaderClass::Render(int indexCount, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix,
	...
	auto result = SetShaderParameters(worldMatrix, viewMatrix, projectionMatrix, texture, ambientColor, diffuseColor, lightPosition,
...
bool ProjectionShaderClass::InitializeShader(HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename) {
	...
	auto result = D3DCompileFromFile(
		vsFilename, NULL, NULL, "ProjectionVertexShader",
	...
	result = D3DCompileFromFile(
		psFilename, NULL, NULL, "ProjectionPixelShader",
