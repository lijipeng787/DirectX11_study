...
bool LightMapShaderClass::Initialize(HWND hwnd) {
  ...
  auto result = InitializeShader(hwnd, L"lightmap.hlsl", L"lightmap.hlsl");
  if (!result) {
    return false;
  }
...
void LightMapShaderClass::Shutdown() { ShutdownShader(); }
...
bool LightMapShaderClass::InitializeShader(HWND hwnd, WCHAR *vsFilename,
                                           WCHAR *psFilename) {
  ...
  auto result = D3DCompileFromFile(
      vsFilename, NULL, NULL, "LightMapVertexShader", "vs_5_0",
  ...
  result = D3DCompileFromFile(psFilename, NULL, NULL, "LightMapPixelShader",
...
void LightMapShaderClass::OutputShaderErrorMessage(ID3D10Blob *errorMessage,
                                                   HWND hwnd,
...
bool LightMapShaderClass::SetShaderParameters(
