...
void DirectX11Device::TurnOnAlphaBlending() {
  ...
  device_context_->OMSetBlendState(alpha_enable_blending_state_, blendFactor,
                                   0xffffffff);
}
...
void DirectX11Device::TurnOffAlphaBlending() {
  ...
  device_context_->OMSetBlendState(alpha_disable_blending_state_, blendFactor,
                                   0xffffffff);
}

ID3D11Device *DirectX11Device::GetDevice() { return device_; }
