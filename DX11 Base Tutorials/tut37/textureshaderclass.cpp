...
bool TextureShaderClass::Render(ID3D11DeviceContext* deviceContext, int vertexCount, int instanceCount, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix,
