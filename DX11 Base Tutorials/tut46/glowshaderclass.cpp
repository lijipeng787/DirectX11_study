...
bool GlowShaderClass::Render(
	int indexCount, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, 
	ID3D11ShaderResourceView* colorTexture, ID3D11ShaderResourceView* glowTexture,float glowStrength) {

	auto result = SetShaderParameters(worldMatrix, viewMatrix, projectionMatrix, colorTexture, glowTexture, glowStrength);
	if (!result) {
		return false;
	}
...
bool GlowShaderClass::InitializeShader(HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename) {
	...
	auto result = D3DCompileFromFile(
		vsFilename, NULL, NULL, "GlowVertexShader", "vs_5_0",
	...
	result = D3DCompileFromFile(
		psFilename, NULL, NULL, "GlowPixelShader", "ps_5_0",
		D3D10_SHADER_ENABLE_STRICTNESS, 0,
