...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_Terrain->Initialize(m_Direct3D->GetDevice(), "../../tertut12/data/heightmap01.bmp", L"../../tertut12/data/dirt01.dds", "../../tertut12/data/colorm01.bmp");
	if(!result)
	{
	...
	result = m_SkyPlane->Initialize(m_Direct3D->GetDevice(), L"../../tertut12/data/cloud001.dds", L"../../tertut12/data/perturb001.dds");
	if(!result)
	{
