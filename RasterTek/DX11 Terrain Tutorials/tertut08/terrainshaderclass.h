...
public:
	...
	void Shutdown();
	bool Render( ID3D11DeviceContext*, int, const XMMATRIX&, const XMMATRIX&, const XMMATRIX&, const XMFLOAT4&, const XMFLOAT4&, const XMFLOAT3&, ID3D11ShaderResourceView* );
