...
bool TerrainShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../../tertut04/terrain.vs", L"../../tertut04/terrain.ps");
	if(!result)
	{
		return false;
	}
...
bool TerrainShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix,
	const XMMATRIX& projectionMatrix, const XMFLOAT4& ambientColor, const XMFLOAT4& diffuseColor, const XMFLOAT3& lightDirection, ID3D11ShaderResourceView* texture)
{
	bool result;
...
bool TerrainShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix,
	const XMMATRIX& projectionMatrix, const XMFLOAT4&  ambientColor, const XMFLOAT4& diffuseColor, const XMFLOAT3& lightDirection,
