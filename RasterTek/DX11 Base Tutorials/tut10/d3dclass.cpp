...
bool D3D12Device::SetPipelineParameters(
	...
	const D3d12ResourcePtr matrix_buffer,
	const D3d12ResourcePtr light_buffer,
	const D3d12ResourcePtr camera_buffer,
	...
	default_graphics_command_list_->SetGraphicsRootConstantBufferView(1, matrix_buffer->GetGPUVirtualAddress());

	default_graphics_command_list_->SetGraphicsRootConstantBufferView(2, camera_buffer->GetGPUVirtualAddress());

	default_graphics_command_list_->SetGraphicsRootConstantBufferView(3, light_buffer->GetGPUVirtualAddress());
...
bool D3D12Device::render(
	...
	SetPipelineParameters(descriptor_arr, matrix_buffer, light_buffer, camera_buffer, num_descriptors);
