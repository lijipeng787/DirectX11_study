...
public:
	...
	D3d12ResourcePtr GetCameraConstantBuffer()const;
...
private:
	...
	D3d12ResourcePtr camera_constant_buffer_ = nullptr;

	CameraBufferType camera_constant_data = {};
