...
bool D3D12Device::SetPipelineParameters(
	...
	const D3d12ResourcePtr constant_buffer_1,
	const D3d12ResourcePtr constant_buffer_2,
	...
	default_graphics_command_list_->SetGraphicsRootConstantBufferView(1, constant_buffer_1->GetGPUVirtualAddress());

	default_graphics_command_list_->SetGraphicsRootConstantBufferView(2, constant_buffer_2->GetGPUVirtualAddress());
...
bool D3D12Device::render(
	...
	SetPipelineParameters(descriptor_arr, constant_buffer_1, constant_buffer_2, num_descriptors);
