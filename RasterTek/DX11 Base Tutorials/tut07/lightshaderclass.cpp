...
bool LightShader::Initialize(WCHAR * vs_shader_filename, WCHAR * ps_shader_filename){
...
BlobPtr LightShader::GetVertexShaderBlob() const{
	return vertex_shader_blob_;
}

BlobPtr LightShader::GetPixelSHaderBlob() const{
