...
bool D3D12Device::SetPipelineParameters(
	...
	default_graphics_command_list_->SetGraphicsRootConstantBufferView(2, light_buffer->GetGPUVirtualAddress());
...
bool D3D12Device::render(
	...
	SetPipelineParameters(descriptor_arr, matrix_buffer, light_buffer, num_descriptors);
